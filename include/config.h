...
/* Define to 1 if SQLORA8 library should be enabled. */
/* #undef HAVE_SQLORA8 */
...
/* Define to 1 if struct 'uvmexp' exist . */
/* #undef HAVE_UVM_UVMEXP */

/* Define to 1 if struct 'uvmexp_sysctl' exist . */
...
/* Define to 1 if __VA_ARGS__ available. */
